...
<div id="container">
    ...
    <h3>Do you really want to delete this person?</h3>
    <p><a href="Controller?action=deletePerson&userid=${userid}" class="back">Delete</a>   <a href="Controller?action=overview" class="back">Cancel</a></p>
